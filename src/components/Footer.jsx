...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden bg-gradient-to-b from-slate-900 to-black border-t border-slate-800">
      {/* Gradient background */}
      <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 to-orange-500/10 pointer-events-none" />
      ...
      <div className="container max-w-7xl mx-auto relative z-10 px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 py-12">
          ...
          <div className="md:col-span-4 space-y-4">
            <Link to="/" className="flex items-center space-x-3">
              <div className="h-14 w-14 rounded-full bg-white flex items-center justify-center p-2 shadow-lg">
                <img 
                  src={logo} 
              ...
              <span className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-orange-400 text-transparent bg-clip-text">
                ViR
              </span>
            </Link>
            <p className="text-gray-400 leading-relaxed">
              Building innovative web solutions with cutting-edge technologies and AI integration. Creating digital experiences that inspire.
            </p>
            ...
            <div className="flex space-x-3">
              ...
              <a
                ...
                className="group h-10 w-10 rounded-full bg-slate-800 hover:bg-green-600 flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="WhatsApp"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group h-10 w-10 rounded-full bg-slate-800 hover:bg-blue-600 flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="Facebook"
              >
                <svg className="h-5 w-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group h-10 w-10 rounded-full bg-slate-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-600 flex items-center justify-center transition-all duration-300 hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group h-10 w-10 rounded-full bg-slate-800 hover:bg-gray-700 flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="GitHub"
              >
                <svg className="h-5 w-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bottom section */}
        <div className="border-t border-slate-800 py-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="text-sm text-gray-400">
            © {new Date().getFullYear()} <span className="text-cyan-400 font-semibold">ViR Developers</span>. All rights reserved.
          </div>
      ...
      <div className="h-1 bg-gradient-to-r from-cyan-500 via-orange-500 to-cyan-500"></div>
    </footer>
  );
};
