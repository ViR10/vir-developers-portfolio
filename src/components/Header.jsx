...
export default function Navbar() {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-gray-400 text-xs">Digital Excellence & AI</p>
              </div>
            </Link>
            ...
            <button
              ...
              className="lg:hidden w-10 h-10 flex items-center justify-center rounded-lg bg-slate-800 hover:bg-slate-700 transition-colors duration-300"
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-20 right-0 bottom-0 w-80 max-w-[85vw] bg-slate-900 z-40 lg:hidden transition-transform duration-300 ${
      ...
      >
        <div className="flex flex-col h-full p-6">
          ...
          {/* Social Links - Mobile */}
          <div className="flex justify-center gap-4 mt-6 pt-6 border-t border-slate-800">
            <a
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-slate-800 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-600 rounded-full flex items-center justify-center transition-colors"
            >
              <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
